# -*- coding: utf-8 -*-
# Gasper Senk
# try 1 pri delanju animacije

# berem z fila, tega predelam v matriko in to matriko v vrsticah 
# izrisujem na sliko in tako izdelam animacijo

import pylab 
import numpy 
import matplotlib.pyplot as plt
import matplotlib.animation as animation
data=numpy.loadtxt("Maxwell_PML.txt")

# data shranim v 101 vrstic po 400 elementov, 1 je dodatna zaradi
# nicelnega casa
